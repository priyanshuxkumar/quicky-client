...
const ChatCard : React.FC<ChatCardProps> = ({ data , onClick}) => {
  ...
  const { setRecipientUser } = useChatContext();
  ...
  return (
    <div onClick={handleClick} className={`transition duration-500 hell px-7 py-2 my-3 cursor-pointer hover:bg-slate-100 dark:hover:bg-black`}>
