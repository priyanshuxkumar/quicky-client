...
import { useCurrentUser, useLoginUser } from "../../hooks/user";
...
export default function Home() {
  ...
  return (
    <>
    {pageLoading ? (<div className="w-full h-screen flex justify-center items-center"><Loading size={80} width={1}/></div>) : 
      (<section>
      <div className="dark:bg-dark-primary-bg h-screen flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          ...
          <form onSubmit={handleLoginForm} className="mt-8">
            <div className="space-y-5">
              ...
              <div>
                ...
                >
                  {isSubmitting ? (<> <Loading size={28} width={2}/>  Please wait </>): ('Login')} 
                </button>
              </div>
            </div>
          </form>
